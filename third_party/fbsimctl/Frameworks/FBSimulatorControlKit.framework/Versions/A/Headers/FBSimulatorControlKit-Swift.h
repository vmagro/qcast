...
SWIFT_MODULE_NAMESPACE_PUSH("FBSimulatorControlKit")
...
@interface FBFileWriter (SWIFT_EXTENSION(FBSimulatorControlKit))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) FBFileWriter * _Nonnull stdOutWriter;)
+ (FBFileWriter * _Nonnull)stdOutWriter SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) FBFileWriter * _Nonnull stdErrWriter;)
+ (FBFileWriter * _Nonnull)stdErrWriter SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, readonly, strong) id <FBEventReporter> _Nonnull reporter;
